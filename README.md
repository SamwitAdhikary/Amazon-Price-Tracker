...
## Working!
- It is a simple python program based on webscrapping and requests. This program sends you email when the selected product's price fell. For sending email you have to enable less secured app in you google account and enter your email and password in the respected field.
